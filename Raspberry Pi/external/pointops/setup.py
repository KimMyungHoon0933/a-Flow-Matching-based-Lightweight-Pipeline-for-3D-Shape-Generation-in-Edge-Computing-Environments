"""
External library from "https://github.com/Silverster98/pointops".
Only necessary modules are included here. Please refer to the original repo for the full code.
"""
